...
def validate_faces_count_eq_frames_count(df_intervals, interval_id, debug=False):
    ...
    inerval_faces_dir = resolve_interval_faces_dir(df_intervals, interval_id)
    ...
    if one_percent_chance() or debug:
        ...
        interval_data_dir = resolve_interval_dir(df_intervals, interval_id)
