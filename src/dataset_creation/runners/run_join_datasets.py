import os
import pandas as pd
from src.common.constants import DATASETS_VOKENIZATION, COL_SPEAKER, COL_DATASET, COL_VOKEN_ID
...
new_dataset_name = f'{DATASET_OLIVER}_{DATASET_NOAH}_Shuffle_Sentence'
...
df_train_shuffled, train_indices, df_test_shuffled, test_indices = shuffle_train_test(df_train, df_test)
...
save_dataset(new_dataset_path, df_all_shuffled, df_train_shuffled, df_test_shuffled)
